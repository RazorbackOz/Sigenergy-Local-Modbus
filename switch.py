...
async def async_setup_entry(
    ...
    #_LOGGER.debug("RBS-switch.py-149- Add plant Switches, coordinator.hub.inverter_connections.items(): %s",coordinator.hub.inverter_connections.items() )
    ...
    for device_name, device_conn in coordinator.hub.inverter_connections.items():
        ...
        #_LOGGER.debug("RBS-switch.py-157- start Add DC Charger sensor, CONF_INVERTER_HAS_DCCHARGER: %s", CONF_INVERTER_HAS_DCCHARGER )
        if device_conn.get(CONF_INVERTER_HAS_DCCHARGER, False):
            #_LOGGER.debug("RBS-switch.py-159- Adding DC Charger sensor, device_name: %s ",device_name )
            ...
            #_LOGGER.debug("RBS-switch.py-162, Adding DC Charger sensor, parent_inverter_id: %s )", parent_inverter_id )
            dc_id = f"{parent_inverter_id}_dc_charger"
            #_LOGGER.debug("RBS-switch.py-164, Adding DC Charger sensor, dc_id: %s )", dc_id )
            ...
            #_LOGGER.debug("RBS-switch.py-174, add Static Sensors, plant_name: %s", plant_name )
            #_LOGGER.debug("RBS-switch.py-174, add Static Sensors, device_name: %s", device_name )
            #_LOGGER.debug("RBS-switch.py-174, add Static Sensors, device_conn: %s", device_conn )
            #_LOGGER.debug("RBS-switch.py-174, add Static Sensors, coordinator: %s", coordinator )
            #_LOGGER.debug("RBS-switch.py-174, add Static Sensors, SigenergySwitch: %s", SigenergySwitch )
            #_LOGGER.debug("RBS-switch.py-174, add Static Sensors, DC_CHARGER_SWITCHES: %s", DC_CHARGER_SWITCHES )
            #_LOGGER.debug("RBS-switch.py-174, add Static Sensors, DEVICE_TYPE_DC_CHARGER: %s", DEVICE_TYPE_DC_CHARGER )
            #_LOGGER.debug("RBS-switch.py-174, add Static Sensors, dc_device_info: %s", dc_device_info )
...
class SigenergySwitch(SigenergyEntity, SwitchEntity):
    ...
    def is_on(self) -> bool:
        ...
        #_LOGGER.debug("RBS-switch.py-249- is_on_fn, return Value: %s, identifier: %s, self.coordinator.data: %s, self.entity_description: %s", 
        #            self.entity_description.is_on_fn(self.coordinator.data, identifier), identifier, self.coordinator.data, self.entity_description)
    ...
    async def async_turn_on(self, **kwargs: Any) -> None:
        ...
        _LOGGER.debug("RBS-switch.py-260- turn_on_fn, identifier: %s", identifier)
        
        await self.entity_description.turn_on_fn(self.coordinator, identifier) # Pass coordinator
        _LOGGER.debug("RBS-switch.py-263- turn_on_fn Complete, identifier: > %s <.", identifier)
    #---------------------------------------------------------------------------
    async def async_turn_off(self, **kwargs: Any) -> None:
        ...
        _LOGGER.debug("RBS-switch.py-271- turn_off_fn identifier: > %s <.", identifier)
        
        await self.entity_description.turn_off_fn(self.coordinator, identifier) # Pass coordinator
        _LOGGER.debug("RBS-switch.py-274- turn_off_fn Complete, identifier: > %s <.", identifier)