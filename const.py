...
#CONF_DC_CHARGER_CONNECTIONS = "dc_charger_connections"  #RBS
CONF_DC_CHARGER_CONNECTIONS = "inverter_connections"   #RBS
...
### RBS  -  DEFAULT_DC_CHARGER_NAME = "Sigen DC Charger"
DEFAULT_DC_CHARGER_NAME = "Sigen Inverter DC Charger"
