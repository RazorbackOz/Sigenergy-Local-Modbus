    ...
    async def _async_update_data(self) -> Dict[str, Any]:
        ...
        try:
            ...
            async with async_timeout.timeout(60):
                ...
                _LOGGER.debug("Update cycle %s: Requesting frequency %s", self._update_counter, current_frequency_type.name)    #RBS Uncomment
                ...
                for inverter_name in self.hub.inverter_connections.keys():
                    ...
                    #_LOGGER.debug("RBS-coordinator.py-97- Fetch inverter data, inverter name : %s", inverter_name)
                    ...
                    #_LOGGER.debug("RBS-coordinator.py-99- Fetch inverter data, inverter_data[inverter_name] : %s", inverter_data[inverter_name])
